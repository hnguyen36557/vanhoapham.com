...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="{{ url('public/admin/dist/css/timeline.css') }}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{ url('public/admin/dist/css/sb-admin-2.css') }}" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="{{ url('public/admin/bower_components/morrisjs/morris.css') }}" rel="stylesheet">
...
<!--     <script src="{{ url('public/admin/bower_components/raphael/raphael-min.js') }}"></script>
    <script src="{{ url('public/admin/bower_components/morrisjs/morris.min.js') }}"></script>
    <script src="{{ url('public/admin/js/morris-data.js') }}"></script> -->
